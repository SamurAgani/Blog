            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ContentID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ContentUserName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ContentMail = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Contacts", x => x.ContentID);
                });
